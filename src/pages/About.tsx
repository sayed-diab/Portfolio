...
const About = () => {
  return (
    ...
    >
      ...
      <p>Whether working as a freelancer or as part of a team, I am committed to delivering exceptional results that exceed expectations. Let’s work together to bring your ideas to life!</p>
    </section>
  );
};
